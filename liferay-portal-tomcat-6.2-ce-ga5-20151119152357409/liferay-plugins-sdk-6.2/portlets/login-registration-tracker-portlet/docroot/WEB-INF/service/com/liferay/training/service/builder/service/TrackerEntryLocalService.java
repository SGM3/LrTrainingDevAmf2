...
/**
 * Provides the local service interface for TrackerEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Shanon Mathai
 * @see TrackerEntryLocalServiceUtil
...
public interface TrackerEntryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TrackerEntryLocalServiceUtil} to access the tracker entry local service. Add custom service methods to {@link com.liferay.training.service.builder.service.impl.TrackerEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
