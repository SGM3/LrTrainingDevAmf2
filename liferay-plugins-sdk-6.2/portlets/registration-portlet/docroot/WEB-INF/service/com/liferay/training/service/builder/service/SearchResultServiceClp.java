 ...
 * @generated
 */
public class SearchResultServiceClp implements SearchResultService {
	public SearchResultServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "getUserFromZip";

		_methodParameterTypes3 = new String[] { "int" };

		_methodName4 = "getUserFromZip";

		_methodParameterTypes4 = new String[] { "int", "int", "int" };

		_methodName5 = "countUsersFromZip";
	...
	public java.util.List<com.liferay.portal.model.User> getUserFromZip(int zip)
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName3,
					_methodParameterTypes3, new Object[] { zip });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<com.liferay.portal.model.User> getUserFromZip(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName4,
					_methodParameterTypes4, new Object[] { zip, start, end });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public long countUsersFromZip(int zip)
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName5,
					_methodParameterTypes5, new Object[] { zip });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
