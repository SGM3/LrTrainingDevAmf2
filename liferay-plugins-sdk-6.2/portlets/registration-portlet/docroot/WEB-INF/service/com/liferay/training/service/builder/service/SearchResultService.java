...
/**
 * Provides the remote service interface for SearchResult. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Shanon Mathai
 * @see SearchResultServiceUtil
...
public interface SearchResultService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SearchResultServiceUtil} to access the search result remote service. Add custom service methods to {@link com.liferay.training.service.builder.service.impl.SearchResultServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
