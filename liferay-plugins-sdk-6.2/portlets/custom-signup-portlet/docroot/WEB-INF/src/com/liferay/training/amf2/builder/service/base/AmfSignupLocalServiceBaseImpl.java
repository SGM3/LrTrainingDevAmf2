...
import com.liferay.training.amf2.builder.service.AmfSignupLocalService;

import javax.sql.DataSource;

/**
 * Provides the base implementation for the amf signup local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.training.amf2.builder.service.impl.AmfSignupLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class AmfSignupLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements AmfSignupLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.training.amf2.builder.service.AmfSignupLocalServiceUtil} to access the amf signup local service.
	 */

	/**
	 * Returns the amf signup local service.
	 *
	 * @return the amf signup local service
	 */
	public com.liferay.training.amf2.builder.service.AmfSignupLocalService getAmfSignupLocalService() {
		return amfSignupLocalService;
	}

	/**
	 * Sets the amf signup local service.
	 *
	 * @param amfSignupLocalService the amf signup local service
	 */
	public void setAmfSignupLocalService(
		com.liferay.training.amf2.builder.service.AmfSignupLocalService amfSignupLocalService) {
		this.amfSignupLocalService = amfSignupLocalService;
	}
	...
	@BeanReference(type = com.liferay.training.amf2.builder.service.AmfSignupLocalService.class)
	protected com.liferay.training.amf2.builder.service.AmfSignupLocalService amfSignupLocalService;
	...
	private AmfSignupLocalServiceClpInvoker _clpInvoker = new AmfSignupLocalServiceClpInvoker();
}