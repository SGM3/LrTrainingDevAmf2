 ...
 * @generated
 */
public class AmfSignupLocalServiceClp implements AmfSignupLocalService {
	public AmfSignupLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName3 = "addUserWithAddressAndPhones";
	...
	public java.util.List<java.lang.String> addUserWithAddressAndPhones(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName3,
					...
					ClpSerializer.translateInput(homeNumber),
						
					ClpSerializer.translateInput(mobileNumber),
						
					ClpSerializer.translateInput(securityQuestionKey),
						
					ClpSerializer.translateInput(secuirtyAnswer),
